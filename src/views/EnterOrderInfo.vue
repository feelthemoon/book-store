  ...
  <div class="grid-container">
    <div class="main">
      <div class="dev-method">
        ...
        <tr></tr>
        <v-btn elevation="2" outlined large class="btn-courier" color="primary">
          Курьер
        </v-btn>
        <v-btn elevation="2" large outlined class="btn-pochta" color="#5DBAEE">
          Почта РФ
        </v-btn>
      </div>
      <div class="info-order">
        <div class="ent-field">Заполните поля:</div>
        <v-text-field
          class="name"
